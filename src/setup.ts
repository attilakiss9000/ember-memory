  ...
  if (hasExistingEmber) {
    ...
    if (addClaudeMd.toLowerCase() === "y") {
      ...
      const snippet = [
        ...
        "- FIRST: Write your full response to the user as normal text. The user must see your response as a regular message, NOT inside a tool call.",
        "- THEN: After your response, call `ember_annotate` or `ember_capture` for both the user's message and your response.",
        ...
        "- The annotation happens AFTER your response, not instead of it. Your response to the user always comes first as plain text.",
        "",
