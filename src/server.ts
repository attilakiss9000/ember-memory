  ...
  const server = new McpServer(
    { name: "ember", version: "0.1.0" },
    {
      instructions: [
        ...
        "",
        "EVERY SINGLE RESPONSE you give: call ember_annotate with BOTH the user's message AND your response.",
        "- Annotate the user's message: role='user', include their content, assign weight/temperature.",
        "- Annotate your own response: role='assistant', include your content, assign weight/temperature.",
