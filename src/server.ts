  ...
  const server = new McpServer(
    { name: "ember", version: "0.1.0" },
    {
      instructions: [
        ...
        "- FIRST: Respond to the user normally. Your response must appear as plain text, NOT inside a tool call.",
        "- THEN: After responding, annotate both the user's message (role='user') and your response (role='assistant').",
